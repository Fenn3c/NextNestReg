...
export default function Input({ value, onChange, id, label, placeholder, required = false, type = 'text', invalid = false, errorText = '', className }: Props) {
  ...
  return (
    <>
      <label className='block mb-2 font-medium text-slate-700' htmlFor={id}>
        {label}
        {required && <span className='text-red-500'>*</span>}
        {hasErrorMessage && <span className='text-red-500 font-normal'> {errorText}</span>}
      </label>
